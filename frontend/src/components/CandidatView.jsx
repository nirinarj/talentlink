...
export default function CandidatView({
  ...
  const handleApplySubmit = async (e) => {
    ...
    // IMPORTANT :
    // Django attend "job_id" et non "job"
    formData.append('job_id', selectedJob.id);

    formData.append(
      'candidate_email',
      currentUser?.email || 'candidat@talentlink.mg'
    );

    formData.append('cv', cvFile);
    formData.append('cover_letter', lmFile);
    ...
    try {
      ...
      const response = await fetch(
        `${API_URL}/api/applications/create/`,
        {
          method: 'POST',
          body: formData
          // NE PAS mettre Content-Type ici.
          // Le navigateur le crée automatiquement pour FormData.
        }
      );
      ...
      if (response.ok) {
        ...
        // ============================================================
        // AJOUTER LA CANDIDATURE DANS L'INTERFACE
        // ============================================================
      ...
      alert(
        "Impossible de joindre le serveur. Vérifiez votre connexion ou l'URL du serveur."
      );
      ...
      {activeTab === 'dashboard' && (
        ...
        >
          ...
          >
            ...
            . Consultez les offres disponibles et suivez l'état
            de vos candidatures en temps réel.
          </p>
        </div>
      )}
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  >
                    Votre Lettre de motivation (PDF / Word)
                  </label>
        ...
        <div>
          ...
          {currentUser?.role !== 'candidat' ? (
            ...
            >
              ...
              >
                Vous n'avez pas l'accès pour entrer.
